...
public class CacheTest {
    static TimelyCache<String, Integer> expensiveComputer = new TimelyCache<>(new ExpensiveFunction());

    /**
     * 使用 CountDownLatch 进行压测
     */
        ...
        for (int i = 0; i < 100; i++) {
            service.submit(() -> {
                ...
                try {
                    ...
                    System.out.println(Thread.currentThread().getName() + " 在 " + time + " 被放行");
